...
public class EnemySpawner : MonoBehaviour
{
    ...
    public void spawnEnemy(float damage, float speed, float health)
    {
        ...
        {
            case 0: //Top
                toSpawn = new Vector3(Random.Range(playerX - 7, playerX + 7), playerY + 10, 0f);
                break;
            case 1: //Left
                toSpawn = new Vector3(playerX - 7, Random.Range(playerY - 7, playerY + 7), 0f);
                break;
            case 2: //Bottom
                toSpawn = new Vector3(Random.Range(playerX - 7, playerX + 7), playerY - 7, 0f);
                break;
            case 3: //Right
                toSpawn = new Vector3(playerX + 7, Random.Range(playerY - 7, playerY + 7), 0f);
                break;
            default:
                toSpawn = new Vector3(0, playerX + 7, 0);
                break;
        }
